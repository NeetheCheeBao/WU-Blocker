...
if __name__ == "__main__":
    ...
    title_label = ttk.Label(main_frame, text="Windows 更新配置", style='Header.TLabel')
    ...
    btn_restore = ttk.Button(main_frame, text="恢复自动更新 (默认设置)", command=restore_updates)
